...
/* 信息 */
.icon-messageEight:before {
  content: "\e632";
  color: v-bind(color);
  font-size: v-bind(size + "px");
}
/* 云计算 */
.icon-cloudComputing:before {
  content: "\e633";
  color: v-bind(color);
  font-size: v-bind(size + "px");
}
